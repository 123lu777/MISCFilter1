...
parser = argparse.ArgumentParser(description='Wind Turbine Image Deblurring')

parser.add_argument('--train_dir', default='./dataset/WindTurbine', type=str, help='Directory of train images')
parser.add_argument('--train_meta', default='./dataset/WindTurbine/WindTurbine_train_list.txt', type=str, help='Path to train list file')
parser.add_argument('--val_dir', default='./dataset/WindTurbine', type=str, help='Directory of validation images')
parser.add_argument('--val_meta', default='./dataset/WindTurbine/WindTurbine_test_list.txt', type=str, help='Path to val list file')
...
parser.add_argument('--session', default='MISCFilter_WindTurbine', type=str, help='session name')
...
parser.add_argument('--val_epochs', default=10, type=int, help='run validation every N epochs')
parser.add_argument('--print_epochs', default=2, type=int, help='print loss every N epochs')
...
######### Model ###########
# turbine_mode=True activates the WindTurbineMotionModule which adds a
# physically-structured rotational displacement field (estimated rotation
# center + angle) to the residual motion at each decoder scale.
model_restoration = myNet(turbine_mode=True)
